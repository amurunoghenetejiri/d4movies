      ...
      >
        <div className="mx-auto flex h-12 md:h-14 max-w-7xl items-center justify-between gap-3 px-3 md:px-6">
          <Link to="/" className="flex items-center gap-2 shrink-0">
            ...
            <Logo size={64} className="hidden md:flex" />
          </Link>
            ...
            {user ? (
              <div className="relative" ref={menuRef}>
                <button
                  ...
                  className="size-5 rounded-full bg-gradient-to-br from-primary to-gold grid place-items-center text-sm font-bold text-primary-foreground"
                  aria-label="Account"
                >
                  {profile?.avatar_url
